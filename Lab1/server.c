...
#include <stdlib.h> //library,macro,functions,variable type(here only atoi - string to number for ports)
#include <string.h> 
#include <sys/socket.h> //Includes a number of definitions of structures needed for sockets
#include <sys/types.h> //definition of a number of data types used in system calls
#define MAX 80 
#define PORT 8080 
